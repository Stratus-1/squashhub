...
interface ClubContextType {
  ...
  club: {
    ...
    visitor_self_booking_fee?: number | null;
    require_visitor_for_member_booking?: boolean | null;
    allow_solo_bookings?: boolean | null;
...
const RESTRICTED_CLUB_COLS =
  "id, contact_person_name, currency_code, currency_symbol, participation_active, visitors_can_book, visitor_booking_fee, visitor_self_booking_fee, require_visitor_for_member_booking, allow_solo_bookings, external_booking_provider, external_booking_url, external_booking_label, uses_gobook, gobook_url, payment_gateway, payment_gateways, payment_gateway_public_key, payment_gateway_fee_percent, gateway_fee_pct_card_local, gateway_fee_pct_card_intl, gateway_fee_pct_wallet, gateway_fee_pct_capitec, honesty_bar_enabled, face_enrolment_required, booking_slot_minutes, booking_open_time, booking_last_slot_time, peak_weekday_start, peak_weekday_end, peak_weekend_start, peak_weekend_end, max_peak_bookings_per_day, max_bookings_per_day, block_back_to_back_bookings, lights_integration_enabled, light_fee_per_hour, sms_enabled, whatsapp_enabled, booking_confirm_enabled, booking_confirm_channels, booking_reminder_enabled, booking_reminder_channels, booking_reminder_hours";
