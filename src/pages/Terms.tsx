          ...
          <CardContent className="p-4 sm:p-6">
            <div className="prose prose-sm max-w-none dark:prose-invert">
              <p>
                ...
                &quot;Service&quot;), a platform operated by <strong>Stratus Software Solutions (Pty) Ltd</strong>{" "}
                (Registration No. 2026/386351/07), a company registered in the Republic of South Africa
                (&quot;Stratus&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;).
                By creating an account or using the Service, you agree to these Terms
                and enter into a binding agreement with Stratus.
              </p>

              <h2>1. Who we are</h2>
              <p>
                SquashHub is owned and operated by <strong>Stratus Software Solutions (Pty) Ltd</strong>{" "}
                (Reg. No. 2026/386351/07). The Service helps squash clubs with court bookings,
              ...
              <p>
                ...
                extent permitted by South African law, Stratus disclaims warranties of any kind, whether express or implied.
              </p>

              <h2>8. Limitation of liability</h2>
              <p>
                To the maximum extent permitted by South African law, Stratus is not liable for indirect, incidental,
              ...
              <h2>9. Termination</h2>
              <p>
                You may stop using the Service at any time. Stratus may suspend or terminate access if needed to
              ...
              <p>
                ...
                <strong>Stratus Software Solutions (Pty) Ltd</strong>. No right, title, or interest in any intellectual
              ...
              <p>
                ...
                of Stratus. Unauthorised use of Stratus&apos;s intellectual property may result in civil and/or criminal
              ...
              <p>
                ...
                yours, but you grant Stratus a non-exclusive, royalty-free, worldwide licence to use, display,
              ...
              <p>
                Stratus may charge clubs a subscription fee for use of the Service, calculated on a per-member
                basis or as otherwise agreed. Payment terms, billing cycles, and pricing are as communicated
                to the club administrator upon subscription. Stratus reserves the right to adjust pricing with
                reasonable notice.
              </p>
              <p>
                Clubs may in turn charge their members fees (membership fees, light fees, event fees, etc.)
                through the Service. Stratus facilitates the collection and tracking of such fees but is not a
                party to the financial arrangement between clubs and their members. Stratus is not responsible
              ...
              <p>
                ...
                you and Stratus regarding your use of the Service and supersede all prior agreements,
              ...
              <p>
                <strong>Stratus Software Solutions (Pty) Ltd</strong><br />
                Reg. No. 2026/386351/07<br />
                Republic of South Africa<br />
                <a href="mailto:support@squashhub.co.za">support@squashhub.co.za</a>
              </p>

              <p className="text-xs text-muted-foreground mt-6">
                © {new Date().getFullYear()} Stratus Software Solutions (Pty) Ltd. All rights reserved.
              </p>
            </div>
          </CardContent>
        </Card>
