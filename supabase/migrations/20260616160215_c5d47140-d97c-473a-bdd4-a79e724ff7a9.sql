...
BEGIN
  ...
  FOR r IN
    ...
    WHERE cm.club_id = p_club_id
      ...
      AND mfc.active = true
      AND (p_category_ids IS NULL OR mfc.id = ANY(p_category_ids))
  LOOP
    v_due := make_date(
...
GRANT EXECUTE ON FUNCTION public.generate_member_renewal_invoices(uuid, uuid[]) TO authenticated, service_role;