ALTER TABLE public.tournaments ADD COLUMN IF NOT EXISTS league_win_conditions jsonb NOT NULL DEFAULT '{}'::jsonb;

GRANT SELECT, INSERT, UPDATE ON public.tournaments TO authenticated;
GRANT ALL ON public.tournaments TO service_role;

DROP TRIGGER IF EXISTS club_champs_compat_insert_trigger ON public.club_champs;
DROP TRIGGER IF EXISTS club_champs_compat_update_trigger ON public.club_champs;
