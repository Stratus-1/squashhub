...
BEGIN
  FOR _r IN
    ...
    WHERE w.active = true
      ...
      AND public.club_has_capability(w.club_id, 'wifi')
...
BEGIN
  ...
  IF NOT public.club_has_capability(_club_id, 'wifi') THEN
    RAISE EXCEPTION 'Member Wi-Fi is switched off for this club';
  END IF;
