ALTER TABLE public.tournaments
  ...
  ADD COLUMN IF NOT EXISTS swiss_pairing_modes jsonb,
  ADD COLUMN IF NOT EXISTS swiss_knockout_qualifiers jsonb;
...
CREATE OR REPLACE VIEW public.club_champs AS
 SELECT t.id, t.club_id, t.owner_org_id, t.name, t.gender, t.status, t.num_groups,
    ...
    t.swiss_pairing_modes, t.swiss_knockout_qualifiers
   FROM tournaments t
