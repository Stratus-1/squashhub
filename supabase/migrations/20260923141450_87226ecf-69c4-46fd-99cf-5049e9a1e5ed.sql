ALTER TABLE public.tournaments
  ADD COLUMN IF NOT EXISTS rotation_avoid_pairs jsonb;

COMMENT ON COLUMN public.tournaments.rotation_avoid_pairs IS 'Rotating-partner doubles: list of [playerA, playerB] id pairs that must never be drawn as partners (e.g. family members).';
