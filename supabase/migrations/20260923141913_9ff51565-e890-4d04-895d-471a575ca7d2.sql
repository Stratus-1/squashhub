ALTER TABLE public.tournaments
  ADD COLUMN IF NOT EXISTS rotation_strength_mode text;

COMMENT ON COLUMN public.tournaments.rotation_strength_mode IS 'Rotating-partner doubles: how strength guides pairings — any | mixed (stronger with weaker) | balanced (similar standard together).';
